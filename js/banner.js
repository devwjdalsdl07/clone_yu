...
// 이벤트 객체를 전달하면서 핸들러 함수 실행
window.addEventListener("load", function (event) {
  let bannerSlide = this.document.querySelector(".banner-slide");
  let bannerBt = this.document.querySelector(".banner-bt");
